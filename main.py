...
all_font_labels = [index for index in range(1094)]
...
async def get_similar_fonts(similar_fonts_request: SimilarFontsRequest):
    ...
    font_candidates = find_similar_fonts(chosen_font_label=similar_fonts_request.font_index, distance_metric='euclidean')
